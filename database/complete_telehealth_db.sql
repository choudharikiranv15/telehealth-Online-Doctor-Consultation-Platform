...
-- ===================================================================
-- 5. APPOINTMENTS TABLE (Core booking system with reschedule feature)
-- ===================================================================
CREATE TABLE appointments (
    ...
    status ENUM('pending', 'confirmed', 'completed', 'cancelled', 'no_show', 'reschedule_requested', 'rejected') DEFAULT 'pending',
...
-- ===================================================================
-- 9. PASSWORD RESET TOKENS TABLE (Password recovery system)
-- ===================================================================
...
-- ===================================================================
-- 11. SYSTEM SETTINGS TABLE (App configuration)
-- ===================================================================
...
SELECT 'Complete TeleHealth database created successfully!' as Status,
       'Includes: Base schema + Ratings + Password Reset + Reschedule Feature' as Features,
